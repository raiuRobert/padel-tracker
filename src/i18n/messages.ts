...
const en = {
  ...
  "setup.date": "Date",
  "setup.cost": "Cost",
  "setup.courtCost": "Court cost",
  "setup.courtNCost": "Court {number} cost",
  "setup.hours": "Hours",
  ...
  "standings.record": "{played} played · {wins}W {losses}L",
  "standings.recordWithSitOuts": "{played} played · {wins}W {losses}L · sat {sitOuts}",
...
const ro: Record<MessageKey, string> = {
  ...
  "setup.date": "Data",
  "setup.cost": "Cost",
  "setup.courtCost": "Cost teren",
  "setup.courtNCost": "Cost teren {number}",
  "setup.hours": "Ore",
  ...
  "standings.record": "{played} jucate · {wins}V {losses}Î",
  "standings.recordWithSitOuts": "{played} jucate · {wins}V {losses}Î · pauze {sitOuts}",
